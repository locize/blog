...
<p class="headline"><i class="material-icons" translated>dashboard</i> Where to start?</p>
...
<p class="headline"><i class="material-icons" translated>translate</i> How to add a new namespace?</p>
...
<p class="headline"><i class="material-icons" translated>translate</i> How to add, edit and delete keys?</p>
